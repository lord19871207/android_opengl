...
public class Camera2VoronoiRendererFragment extends RendererFragment implements SurfaceTexture.OnFrameAvailableListener {

    private static final String RENDERER_ID = "renderer.camera2effect.voronoi";
    ...
    public int getTitleStringId() {
        return R.string.renderer_camera2effect_voronoi_title;
    }

    @Override
    public int getCaptionStringId() {
        return R.string.renderer_camera2effect_voronoi_caption;
    }
    ...
    public void onSurfaceCreated() {
        ...
        try {
            ...
            glProgramEffectVoronoi = new GlProgram(
                    GlUtils.loadString(getActivity(), "shaders/camera2effect/effect_voronoi_vs.txt"),
                    GlUtils.loadString(getActivity(), "shaders/camera2effect/effect_voronoi_fs.txt"),
                    null)
                    .useProgram();
