...
public class Camera2OilPaintingEffectRendererFragment extends RendererFragment implements SurfaceTexture.OnFrameAvailableListener {

    private static final String RENDERER_ID = "renderer.camera2effect.oil.painting";
    ...
    public int getTitleStringId() {
        return R.string.renderer_camera2effect_oil_painting_title;
    }

    @Override
    public int getCaptionStringId() {
        return R.string.renderer_camera2effect_oil_painting_caption;
    }
    ...
    public void onSurfaceCreated() {
        ...
        try {
            ...
            glProgramEffectOilPainting = new GlProgram(
                    GlUtils.loadString(getActivity(), "shaders/camera2effect/effect_oil_painting_vs.txt"),
                    GlUtils.loadString(getActivity(), "shaders/camera2effect/effect_oil_painting_fs.txt"),
                    null)
                    .useProgram();
