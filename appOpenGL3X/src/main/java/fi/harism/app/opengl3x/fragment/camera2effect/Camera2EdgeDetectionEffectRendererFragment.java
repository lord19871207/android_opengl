...
public class Camera2EdgeDetectionEffectRendererFragment extends RendererFragment implements SurfaceTexture.OnFrameAvailableListener {

    private static final String RENDERER_ID = "renderer.camera2effect.edge.detection";
    ...
    public int getTitleStringId() {
        return R.string.renderer_camera2effect_edge_detection_title;
    }

    @Override
    public int getCaptionStringId() {
        return R.string.renderer_camera2effect_edge_detection_caption;
    }
    ...
    public void onSurfaceCreated() {
        ...
        try {
            ...
            glProgramEffectEdgeDetection = new GlProgram(
                    GlUtils.loadString(getActivity(), "shaders/camera2effect/effect_edge_detection_vs.txt"),
                    GlUtils.loadString(getActivity(), "shaders/camera2effect/effect_edge_detection_fs.txt"),
                    null)
                    .useProgram();
